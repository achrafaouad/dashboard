...
export class ServiceService {
  ...
  public get_phases():Observable<Array<Geom>>{
    return this.httpClient.get<Array<Geom>>(`${this.apiUrl}/`);
  }
  
  public spliteF(data:any):Observable<number>{
    return this.httpClient.post<number>(`${this.apiUrl}/spliteF`,data);
  }

  public updatephase(data:any):Observable<void>{
    return this.httpClient.post<void>(`${this.apiUrl}/updatephase`,data);
  }
  
  public getGantt(data:any):Observable<any>{
    return this.httpClient.post<any>(`${this.apiUrl}/getGantt`,data);
  }
  public alltasks():Observable<any>{
    return this.httpClient.get<any>(`${this.apiUrl}/alltasks`);
  }
  
  public addtask(data:any):Observable<any>{
    return this.httpClient.post<any>(`${this.apiUrl}/addTask`,data);
  }
